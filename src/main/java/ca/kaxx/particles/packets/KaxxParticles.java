...
public class KaxxParticles {
    ...
    private double z;
    /**
     * Represents the offset on the X-axis for positioning particles in the KaxxParticles class.
     * <p>
     * This variable is used to determine the amount of offset to apply to the X position of particles when rendering. In the context of the KaxxParticles class, particles are rendered
     ...
     *
     * @see KaxxParticles#KaxxParticles(EnumParticle, boolean, double, double, double, float, float, float, float, int, int[])
     * @see KaxxParticles#send(Player)
     */
    private float offsetX;
    /**
     * Represents the offset on the Y-axis for positioning particles in the KaxxParticles class.
     * <p>
     * This variable is used to determine the amount of offset to apply to the Y position of particles when rendering. In the context of the KaxxParticles class, particles are rendered
     *  in the game world and this offset is used to position them relative to the specified coordinates.
     * <p>
     * The initial value of this variable is undefined. It is recommended to set it to a suitable value before using it to ensure proper placement of particles.
     *
    ...
    /**
     * Represents the offset on the Z-axis for positioning particles in the KaxxParticles class.
     * <p>
     * This variable is used to determine the amount of offset to apply to the Z position of particles when rendering. In the context of the KaxxParticles class, particles are rendered
     *  in the game world and this offset is used to position them relative to the specified coordinates.
     * <p>
     * The initial value of this variable is undefined. It is recommended to set it to a suitable value before using it to ensure proper placement of particles.
     *
